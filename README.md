...
Automated invoice parsing and structured data extraction using Donut

`invoice` `document-ai` `donut` `information-extraction` `pytorch`

## Overview

This repository implements a complete pipeline for **invoice parser**, covering
...
- Relevant papers and resources for invoice parser
